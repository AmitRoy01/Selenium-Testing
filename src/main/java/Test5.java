...
public class Test5 {
    ...
    private void runAllTests() {
        ...
        themeSequences.add(Arrays.asList("light", "dark", "os-default"));    // Test case 1
        themeSequences.add(Arrays.asList("light", "os-default", "dark"));    // Test case 2
        themeSequences.add(Arrays.asList("dark", "light", "os-default"));    // Test case 3
        themeSequences.add(Arrays.asList("dark", "os-default", "light"));    // Test case 4
        themeSequences.add(Arrays.asList("os-default", "light", "dark"));    // Test case 5
        themeSequences.add(Arrays.asList("os-default", "dark", "light"));     // Test case 6
